  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] font-sans text-gray-900 pb-20 relative">
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="mt-auto">
                      ...
                      <button 
                        onClick={(e) => handleOpenBottomSheet(e, p)}
                        className="w-full border-2 border-[#5C3A21] text-[#5C3A21] py-1.5 rounded-lg text-[10px] font-extrabold flex items-center justify-center gap-1 hover:bg-[#5C3A21] hover:text-white transition-colors"
                      >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex justify-around items-center py-2 pb-safe shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)] z-40">
        <div className="flex flex-col items-center p-2 text-[#5C3A21] cursor-pointer" onClick={() => setSelectedCategory("All")}>
